            ...
            <div class="wrapper cf container">
                <div class="full_width">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon">https://data.developer-test.nhs.uk/hscorgrefdata/</span>
			  ...
			  <pre id="interactive_output" class="pre-scrollable">
{
  ...
  "links": [
    {
      "href": "https://data.developer-test.nhs.uk/hscorgrefdata/organisations/A",
      "rel": "self"
    }
  ], 
  ...
  "roles": [
    {
      ...
      "links": [
        {
          "href": "https://data.developer-test.nhs.uk/hscorgrefdata/role-types/RO128",
          "rel": "role-type"
        }
      ], 
      "operationalStartDate": "1994-04-01", 
                    ...
                    <script>
                        (function() {
                            ...
                            window.interactive_call = function() {
                                ...
                                var call_url = 'https://data.developer-test.nhs.uk/hscorgrefdata/' + content;
