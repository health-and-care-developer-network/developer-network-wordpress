<?php
/*
Template Name: Cookie Policy (Main Site)
*/
?>
					...
					<div class="three_quarters">
							...
							<div class="content_wrap cf">
								<article class="cf">
									...
									<?php the_content(); ?>
									<p>&nbsp;</p>
									<script id="CookieDeclaration" src="https://consent.cookiebot.com/30398f35-a144-4edd-a779-05481f9da7b3/cd.js" type="text/javascript" async></script>
