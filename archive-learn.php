    ...
    <div class="main_content cf">
        ...
        <div class="wrapper cf container">
            <div class="one_quarter tree_wrap">
                <?php
                echo hdnPosts::generateTemplateTransient('learn_sidebar', function () {
                    ?>
                            ...
                            while (have_posts()) {
                                ...
                                <article class="blog_post cf">
                                    ...
                                    <ul class="blog_meta cf">
                                        <li class="by"><span class="meta_icon" aria-hidden="true"
                                                             data-icon="&#x23;"></span><?php the_author(); ?> </li>
                                        <li class="on"><span class="meta_icon" aria-hidden="true"
                                                             data-icon="&#x25;"></span><?php the_time('j M Y'); ?></li>
                                        <li class="in"><span class="meta_icon" aria-hidden="true"
                                                             data-icon="&#x2c;"></span><?php the_terms($post->ID, 'learning-categories', '', '', ''); ?>
                                        </li>
                                        <li class="in"><span class="meta_icon" aria-hidden="true"
                                                             data-icon="&#x2c;"></span><?php the_terms($post->ID, 'learning-key-words', '', ', ', ''); ?>
                                        </li>
                                        <li><?php if (function_exists('zilla_likes')) zilla_likes(); ?></li>
                                    </ul>
                                    <?php the_excerpt(); ?>
                                    <a href="<?php the_permalink(); ?>" class="btn orange_btn">Read Article <span
                                                class="btn_icon" aria-hidden="true" data-icon="&#x29;"></span></a>
                                </article>
                    <?php
                            } // end while
                        } // end if
